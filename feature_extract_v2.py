...
if __name__ == "__main__":
    ...
    train_file = pd.read_csv(data_path + 'train_ver2.csv',
    ...
    test_file = pd.read_csv(data_path + 'test_ver2.csv',
                            dtype={'age': 'str', 'antiguedad': 'str', 'renta': 'str'},
    ...
    df_test.to_csv(data_path + '../feats/test_feats_v2.csv', index=False)
    print(datetime.datetime.now() - start_time)
